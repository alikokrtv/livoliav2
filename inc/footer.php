...
?>
    ...
    <a href="https://wa.me/905449313961?text=Merhaba,%20ürünleriniz%20hakkında%20bilgi%20almak%20istiyorum." 
       ...
       data-i18n="whatsapp.title">
        ...
        <span class="whatsapp-tooltip" data-i18n="whatsapp.tooltip">WhatsApp ile Yaz</span>
    </a>

    <footer class="luxury-footer" id="iletisim">
        <div class="footer-intro">
            <h3 data-i18n="footer.title">LIVOLIA HOME TEXTILES</h3>
        ...
        <div class="footer-main">
            <div class="footer-col" style="flex: 2;">
                <h5 data-i18n="footer.contact">İLETİŞİM</h5>
                <div class="footer-links">
                    ...
                    <span class="footer-link" style="display:block; margin-top:10px; line-height:1.5; color: #a9a9a9;" data-i18n="footer.address">Kazım Karabekir Mh. Muhsin Yazıcıoğlu Bulvarı No:114,<br>Yıldırım/Bursa Türkiye</span>
                </div>
            </div>
            <div class="footer-col">
                <h5 data-i18n="footer.social">SOSYAL MEDYA</h5>
                <div class="footer-links">
            ...
            <div class="footer-col">
                <h5 data-i18n="footer.explore">KEŞFEDİN</h5>
                <div class="footer-links">
                    <a href="<?= BASE_URL ?>/koleksiyon.php" class="footer-link" data-i18n="nav.collection">Koleksiyon</a>
                    <a href="<?= BASE_URL ?>/hakkimizda.php" class="footer-link" data-i18n="nav.about">Hakkımızda</a>
                    <a href="<?= BASE_URL ?>/misyon-vizyon.php" class="footer-link" data-i18n="nav.mission">Misyon &amp; Vizyon</a>
                    <a href="<?= BASE_URL ?>/blog.php" class="footer-link" data-i18n="nav.blog">Blog</a>
                    <a href="<?= BASE_URL ?>/contact.php" class="footer-link" data-i18n="nav.contact">İletişim</a>
                </div>
            </div>
            <div class="footer-col">
                <h5 data-i18n="footer.legal">YASAL</h5>
                <div class="footer-links">
                    <a href="<?= BASE_URL ?>/kvkk.php" class="footer-link" data-i18n="footer.kvkk">KVKK</a>
                    <a href="<?= BASE_URL ?>/cerez.php" class="footer-link" data-i18n="footer.cookie">Çerez Politikası</a>
                </div>
            </div>
        </div>
        <div style="text-align:center;padding:30px 6vw;border-top:1px solid rgba(0,0,0,0.07);margin-top:40px">
            <small style="color:rgba(0,0,0,0.56);font-size:.88rem;letter-spacing:1.4px">
                &copy; <?= date('Y') ?> LIVOLIA HOME TEXTILES — <span data-i18n="footer.rights">TÜM HAKLARI SAKLIDIR</span>
            </small>
        </div>
    </footer>
